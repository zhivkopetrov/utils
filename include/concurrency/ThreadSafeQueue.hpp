...
#ifndef UTILS_INCLUDE_CONCURRENCY_THREADSAFEQUEUE_HPP_
#define UTILS_INCLUDE_CONCURRENCY_THREADSAFEQUEUE_HPP_
...
#endif /* UTILS_INCLUDE_CONCURRENCY_THREADSAFEQUEUE_HPP_ */
