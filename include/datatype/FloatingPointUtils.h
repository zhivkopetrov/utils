#ifndef UTILS_INCLUDE_DATATYPE_FLOATINGPOINTUTILS_H_
#define UTILS_INCLUDE_DATATYPE_FLOATINGPOINTUTILS_H_
...
#endif /* UTILS_INCLUDE_DATATYPE_FLOATINGPOINTUTILS_H_ */
