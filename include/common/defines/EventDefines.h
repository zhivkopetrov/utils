#ifndef UTILS_INCLUDE_COMMON_DEFINES_EVENTDEFINES_H_
#define UTILS_INCLUDE_COMMON_DEFINES_EVENTDEFINES_H_
...
enum class TouchEvent : uint8_t { UNKNOWN = 0, PRESS, DRAG, RELEASE };
...
#endif /* UTILS_INCLUDE_COMMON_DEFINES_EVENTDEFINES_H_ */
