...
#ifndef UTILS_INCLUDE_COMMON_AUTOCIRCULARBUFFER_HPP_
#define UTILS_INCLUDE_COMMON_AUTOCIRCULARBUFFER_HPP_
...
#endif /* UTILS_INCLUDE_COMMON_AUTOCIRCULARBUFFER_HPP_ */
