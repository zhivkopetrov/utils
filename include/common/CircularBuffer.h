#ifndef UTILS_INCLUDE_COMMON_CIRCULARBUFFER_H_
#define UTILS_INCLUDE_COMMON_CIRCULARBUFFER_H_
...
class CircularBuffer {
 public:
   ...
   * */
  template <class T>
  inline CircularBuffer &operator<<(const T value) {
...
#endif /* UTILS_INCLUDE_COMMON_CIRCULARBUFFER_H_ */
